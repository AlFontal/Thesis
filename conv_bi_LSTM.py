...
logdir = "/logs2/{}-{}-{}-drop{}-{}x11)seqlen={}conv+biLSTM".format(
...
# Apply both forward and backward LSTM layers
...
final_concat = tf.concat([un_lstms, conv_out], 1)

fc1 = tf.nn.dropout(fc_layer(final_concat, n_final_features + n_units_lstm * 2,
                             n_units_fc, relu=True, name="fc1"), keep_prob)

...
def get_weights(shape):
    """
    Given a certain shape, it returns a tensor containing values from a
    truncated normal distribution with mean = 0 and sd = 0.1. All values
    are in the range [-0.1, 0.1].
